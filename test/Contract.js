...
describe("Contract", function () {
  ...
  it("should enable creators to create a project", async function () {
    // const creatorBalance = (await ethers.provider.getBalance(creator.address)).toNumber()
    await contract.createProject(
      "A project title",
      "A project description. It can be a few sentences, or it can be long paragraphs. I'll keep mine short.",
    ...
    const [project] = await contract.getProjects()
    console.log({ ...project })
